DROP DATABASE IF EXISTS Session07_4;
create database Session07_4;
use Session07_4;
...
select c.name , ( select count(*) from orders o where o.customer_id = c.id ) as amount from customer c;
